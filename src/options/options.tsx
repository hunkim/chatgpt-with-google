...
import PrmoptNumber from "src/components/promptNumber";

const Footer = (props: { language: string }) => (
  <div className="wcg-flex wcg-flex-col wcg-items-center wcg-p-4">
    <p
      style={{ whiteSpace: "pre-line" }}
      className="wcg-text-sm wcg-m-0 wcg-p-1 wcg-text-center"
    >
      {getTranslation(localizationKeys.UI.supportMe)}
    </p>
    <a
      className="wcg-p-4"
      href="https://www.buymeacoffee.com/googlechatgpt?utm_source=webchatgpt&utm_medium=options_page"
      target="_blank"
...
export default function OptionsPage() {
  ...
  const numberOfResultsHandler = (num: string) => {
  ...
  return (
    <div className="wcg-w-3/5 wcg-flex wcg-flex-col wcg-items-center">
      ...
      <PrmoptNumber num={numberOfResults} numHandler={numberOfResultsHandler} />
